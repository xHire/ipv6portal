ActionController::Routing::Routes.draw do |map|
  ...
  map.wiki        ':page', :controller => 'wiki'
  map.edit_wiki   ':page/editovat', :controller => 'wiki', :action => :edit, :conditions => { :method => :get }
  map.update_wiki ':page/editovat', :controller => 'wiki', :action => :update, :conditions => { :method => :put }
